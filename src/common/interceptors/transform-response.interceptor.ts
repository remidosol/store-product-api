...
import { PostgreTypeOrmClassSerializerInterceptor } from "../postgresql";
...
export function TransformResponseInterceptor(classToSerialize: Type): typeof ClassSerializerInterceptor {
  const PostgreTypeOrmSerializer = PostgreTypeOrmClassSerializerInterceptor(classToSerialize);

  return class TransformInterceptor extends PostgreTypeOrmSerializer {
